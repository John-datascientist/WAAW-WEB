...
function SectorMarquee() {
  ...
  return (
    <div className="relative overflow-hidden border-y border-white/10 bg-pu2/40 py-3" aria-hidden="true">
      <div className="flex w-max animate-marquee gap-10 motion-reduce:animate-none">
        {[...track, ...track].map((s, i) => (
          <span key={i} className="flex shrink-0 items-center gap-2 font-mono text-xs uppercase tracking-[0.2em] text-puLight">
      ...
      <section className="relative mx-auto max-w-5xl px-6 pt-6">
        <div className="grid animate-fade-up gap-10 rounded-lg bg-card p-8 shadow-xl sm:grid-cols-2 sm:gap-6 sm:p-12 sm:pb-16 sm:[margin-bottom:-4.5rem]">
          <div>
            ...
            <h1 className="mb-6 font-display text-4xl italic leading-tight text-tx sm:text-[2.75rem]">
              ...
              <span
                className="relative text-ch not-italic sm:whitespace-nowrap animate-fade-up"
