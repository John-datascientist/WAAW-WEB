...
import { Newsreader, IBM_Plex_Mono, Inter, Fraunces } from 'next/font/google';
import './globals.css';
...
// A more dramatic display serif reserved for the landing page's hero
// headline only — the rest of the site keeps Newsreader, this just gives
// the single "signature" statement its own distinct, editorial weight.
const fraunces = Fraunces({ subsets: ['latin'], weight: ['600'], style: ['italic'], variable: '--font-fraunces' });
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${newsreader.variable} ${plexMono.variable} ${inter.variable} ${fraunces.variable}`}>
